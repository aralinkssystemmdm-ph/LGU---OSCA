...
import { Search, UserPlus, ChevronRight, X, AlertCircle, CheckCircle2, ArrowRight, ChevronLeft } from 'lucide-react';
                ...
                <div className="divide-y divide-slate-50">
                  {filteredRecords.length === 0 ? (
                    <div className="px-6 py-12 text-center">
                      <p className="text-slate-400 font-semibold mb-2">No matches found in LCR database.</p>
                      <button 
                        onClick={() => onProceed(null)}
