  ...
  const fetchMasterlistData = async (searchIdOverride?: string) => {
    ...
    try {
      const response = await fetch(
        `https://api-dbosca.phoenix.com.ph/api/masterlist?search=${searchId}`,
        {
          headers: {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const endpoints = [
          { url: "https://api-dbosca.phoenix.com.ph/api/benefit-applications", type: "benefit-applications" },
          { url: "https://api-dbosca.phoenix.com.ph/api/social-pension", type: "social-pension" },
          { url: "https://api-dbosca.phoenix.com.ph/api/birthday-incentives", type: "birthday-incentives" },
          { url: "https://api-dbosca.phoenix.com.ph/api/wedding-anniversary-incentives", type: "wedding-anniversary-incentives" }
        ];
